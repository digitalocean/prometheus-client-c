...
static void* prom_map_get_internal(const char *key,
                                   size_t *size,
                                   size_t *max_size,
...
void* prom_map_get(prom_map_t *self, const char *key) {
  ...
  void *payload = prom_map_get_internal(
    key,
    &self->size,
    &self->max_size,
    self->keys,
...
static int prom_map_set_internal(const char *key,
                                 void *value,
                                 size_t *size,
                                 size_t *max_size,
                                 prom_linked_list_t *keys,
...
static int prom_map_delete_internal(const char *key,
                                     size_t *size,
                                     size_t *max_size,
                                     prom_linked_list_t *keys,
                                     prom_linked_list_t **addrs,
